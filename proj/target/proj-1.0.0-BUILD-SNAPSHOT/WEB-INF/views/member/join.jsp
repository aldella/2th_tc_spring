...
<div class="container">
    <form action="/member/login.do" method="post">
        <div class="row">
            <h4>Account</h4>
            <div class="input-group input-group-icon"><input type="text" placeholder="아이디" id="userId" />
                <div class="input-icon"><i class="fa fa-user">123</i></div>
            </div>
            <div class="input-group input-group-icon"><input type="password" placeholder="비밀번호" id="userPwd" />
            ...
            <br>
            <div class="input-group input-group-icon"><input type="text" placeholder="이름" id="userName" />
                <div class="input-icon"><i class="fa fa-user"></i></div>
            </div>
            <div class="input-group input-group-icon"><input type="email" placeholder="이메일" id="email" />
        ...
        <div class="row">
            ...
            <div class="input-group">
	            <input id="payment-method-card" type="radio" name="gender" value="male" checked />
	            <label for="payment-method-card">
	            	<span><i class="fa fa-cc-visa"></i>남성</span>
	            </label>
	            <input id="payment-method-paypal" type="radio" name="gender" value="female" />
            ...
            <div class="col-half">
	            <div class="input-group input-group-icon">
	            	<input type="text" placeholder="우편번호" id="postnum" />
	                <div class="input-icon"><i class="fa fa-credit-card"></i></div>
	            </div>
            </div>
       	</div>
       	<div class="row">
            <div class="input-group input-group-icon"><input type="email" id="phone" placeholder="전화번호" />
                <div class="input-icon"><i class="fa fa-envelope"></i></div>
            </div>
        </div>
        <div class="row">
