            ...
            <form id="enrollForm" method="post" action="insert.do" enctype="multipart/form-data">
                <table algin="center">
                    ...
                    <tr>
                        <th colspan="2">
                            <div id="img-area">
                                <img id="img-area-box" src="https://t1.kakaocdn.net/friends/www/talk/kakaofriends_talk_2018.png" alt="">
                            </div>
                        </th>
                    </tr>
                </table>
                ...
                function loadImg(inputFile) {
                	// inputFile : 현재 change가 일어난 <input type="file"> 요소 객체 그 자체가 전부 전달됨
                	// type="file"인 자바스크립트 객체는, files라고 하는 Object 객체가 나온다.
                	if(inputFile.files.length) { //파일이 존재하면
                		const reader = new FileReader();
                		reader.readAsDataURL(inputFile.files[0]);
                		//해당 파일을 read하는 순간, 파일만의 아주 긴 url을 생성. url을 이미지의 src속성 값으로 지정할 것.
                		reader.onload = e => {
                			document.getElementById('img-area-box').src=e.target.result;
                		}
                	}
                }
                </script>
